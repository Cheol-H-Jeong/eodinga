...
def _cmd_stats(args: argparse.Namespace) -> int:
    ...
    snapshot = StatsSnapshot(
        ...
        crash_log_size_histogram=histogram_snapshot("crash_log_size_bytes"),
        ...
        recent_snapshot_count=int(metrics["recent_snapshot_count"]),
        recent_snapshot_limit=int(metrics["recent_snapshot_limit"]),
