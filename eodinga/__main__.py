...
def _cmd_stats(args: argparse.Namespace) -> int:
    ...
    snapshot = StatsSnapshot(
        ...
        watcher_queue_retries=counter_value("watcher_queue_retries"),
        ...
        watch_pending_events_histogram=histogram_snapshot("watch_pending_events"),
        watch_queue_depth_histogram=histogram_snapshot("watch_queue_depth"),
