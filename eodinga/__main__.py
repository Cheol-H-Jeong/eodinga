...
def _cmd_stats(args: argparse.Namespace) -> int:
    ...
    snapshot = StatsSnapshot(
        ...
        watcher_backpressure_events=counter_value("watcher_backpressure_events"),
        watcher_enqueue_aborted=counter_value("watcher_enqueue_aborted"),
        watcher_queue_high_watermark=counter_value("watcher_queue_high_watermark"),
        watcher_pending_high_watermark=counter_value("watcher_pending_high_watermark"),
        ...
        index_roots_indexed=counter_value("index_roots_indexed"),
        ...
        index_root_latency_histogram=histogram_snapshot("index_root_latency_ms"),
