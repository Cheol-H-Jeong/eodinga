...
def apply_theme(app: QApplication, theme_name: str = "light") -> Palette:
    ...
    if app.property("_eodinga_theme_name") == theme_name and app.property("_eodinga_theme_qss") == qss:
        return palette
    apply_palette(app, palette)
    app.setStyleSheet(qss)
    app.setProperty("_eodinga_theme_name", theme_name)
    app.setProperty("_eodinga_theme_qss", qss)
    return palette
