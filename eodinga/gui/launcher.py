...
from eodinga.gui.launcher_support import ResultListModel, default_search, format_indexing_footer, format_indexing_status
...
class LauncherPanel(QWidget):
    ...
    def __init__(
        ...
        self.shortcut_label.setAccessibleName("Launcher keyboard shortcuts")
