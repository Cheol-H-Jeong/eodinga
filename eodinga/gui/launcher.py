...
class LauncherPanel(QWidget):
    ...
    def __init__(
        ...
        self.filter_chip_label.setAccessibleName("Launcher active filters")
        ...
        self.status_chip.setAccessibleName("Launcher status chip")
        ...
        self.status_label.setAccessibleName("Launcher query status")
        self.status_label.setProperty("role", "secondary")
        self.empty_state = EmptyState("Type to search", "Recent queries and indexing progress will appear here.", self)
        self.empty_state.setAccessibleName("Launcher empty state")
        self.empty_state.title_label.setAccessibleName("Launcher empty state title")
        self.empty_state.body_label.setAccessibleName("Launcher empty state body")
        self.empty_state.details_label.setAccessibleName("Launcher empty state details")
