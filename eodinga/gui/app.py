...
class EodingaWindow(QMainWindow):
    def __init__(
        ...
        self.settings_tab.set_always_on_top(self._config.launcher.always_on_top)
        self.settings_tab.hotkey_change_requested.connect(self._change_hotkey)
        self.settings_tab.always_on_top_changed.connect(self._change_launcher_always_on_top)
    ...
    def _change_launcher_always_on_top(self, enabled: bool) -> None:
        self.launcher_window.apply_always_on_top(enabled)
