...
class EodingaWindow(QMainWindow):
    def __init__(
        ...
        self.launcher_state.recent_queries_changed.connect(self._persist_recent_queries)
    ...
    def _persist_recent_queries(self, queries: list[str]) -> None:
        if self._config.launcher.recent_queries == queries:
            return
