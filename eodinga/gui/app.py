...
class EodingaWindow(QMainWindow):
    def __init__(
        ...
        self.launcher_state.recent_queries_changed.connect(self._persist_launcher_queries)
        self.launcher_state.pinned_queries_changed.connect(self._persist_launcher_queries)
    ...
    def _persist_launcher_queries(self, _: list[str]) -> None:
        self._config.launcher = self._config.launcher.model_copy(
            update={
                "recent_queries": self.launcher_state.recent_queries,
                "pinned_queries": self.launcher_state.pinned_queries,
            }
        )
        self._config.save(self._config_path)
