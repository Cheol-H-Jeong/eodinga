...
class EmptyState(QWidget):
    def __init__(self, title: str, body: str, parent=None) -> None:
        ...
        self.body_label.setAccessibleName("Empty state summary")
        self.hints_label = QLabel("", self)
        self.hints_label.setProperty("role", "secondary")
        self.hints_label.setWordWrap(True)
        self.hints_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.hints_label.setAccessibleName("Empty state keyboard hints")
    ...
    def set_content(self, title: str, body: str, details: str = "", hints: str = "") -> None:
        self.title_label.setText(title)
        self.body_label.setText(body)
        self.hints_label.setText(hints)
        self.hints_label.setVisible(bool(hints))
