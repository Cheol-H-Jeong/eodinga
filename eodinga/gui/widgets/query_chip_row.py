...
class QueryChipRow(QWidget):
    def __init__(
        ...
        *,
        ...
        button_accessible_name_prefix: str = "Use query",
        parent=None,
    ) -> None:
        super().__init__(parent)
        self._on_chip_clicked = on_chip_clicked
        self._button_accessible_name_prefix = button_accessible_name_prefix
    ...
    def set_queries(self, queries: list[str]) -> None:
        ...
        for query in queries:
            ...
            button.setAccessibleName(f"{self._button_accessible_name_prefix} {query}")
