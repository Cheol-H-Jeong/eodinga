...
class LauncherActionBar(QWidget):
    def __init__(self, parent=None) -> None:
        ...
        self.open_button.setToolTip("Open selected result (Enter)")
        ...
        self.reveal_button.setToolTip("Reveal selected result (Ctrl+Enter)")
        ...
        self.copy_path_button.setToolTip("Copy selected result path (Alt+C)")
        ...
        self.copy_name_button.setToolTip("Copy selected result name (Alt+N)")
        ...
        self.properties_button.setToolTip("Show selected result properties (Shift+Enter)")
