...
class LauncherPreviewPane(QWidget):
    def __init__(self, parent=None) -> None:
        ...
        eyebrow.setAccessibleName("Launcher preview label")
        self.title_label = QLabel(self)
        self.title_label.setWordWrap(True)
        self.title_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        self.title_label.setAccessibleName("Launcher preview title")
        self.path_label = QLabel(self)
        self.path_label.setProperty("role", "secondary")
        self.path_label.setWordWrap(True)
        self.path_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        self.path_label.setAccessibleName("Launcher preview path")
        ...
        self.snippet_label.setAccessibleName("Launcher preview snippet")
