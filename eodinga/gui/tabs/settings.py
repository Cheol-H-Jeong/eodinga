...
class SettingsTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.title_label.setAccessibleName("Settings title")
        self.body_label = QLabel("Configure the hotkey, theme, and launcher window behavior.", self)
        self.body_label.setProperty("role", "secondary")
        self.body_label.setAccessibleName("Settings summary")
        self.system_theme_checkbox = QCheckBox("Use system theme", self)
        self.system_theme_checkbox.setAccessibleName("Use system theme")
        self.system_theme_checkbox.setAccessibleDescription("Follow the desktop appearance for the main window and launcher.")
        ...
        self.frameless_checkbox.setAccessibleDescription("Toggle launcher window chrome for a cleaner command palette surface.")
        ...
        self.always_on_top_checkbox.setAccessibleDescription("Keep the launcher above other windows when it is visible.")
        ...
        self.remap_hotkey_button.setAccessibleDescription("Enter a new global shortcut for showing the launcher.")
    ...
    def set_hotkey_combo(self, combo: str) -> None:
        ...
        self.hotkey_label.setAccessibleDescription("Shows the global launcher shortcut currently configured for eodinga.")
