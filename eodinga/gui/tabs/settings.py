...
class SettingsTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setAccessibleDescription("Adjust appearance, launcher behavior, and the global hotkey.")
        ...
        self.system_theme_checkbox.setAccessibleDescription("Follow the operating system light or dark theme.")
        ...
        self.frameless_checkbox.setAccessibleDescription("Hide the native window frame around the launcher.")
        ...
        self.always_on_top_checkbox.setAccessibleDescription("Keep the launcher above other windows when shown.")
        ...
        self.hotkey_label.setAccessibleDescription("Shows the currently configured launcher shortcut.")
        self.remap_hotkey_button = SecondaryButton("Remap hotkey", self)
        self.remap_hotkey_button.setAccessibleName("Remap hotkey")
        self.remap_hotkey_button.setAccessibleDescription("Choose a new global keyboard shortcut for the launcher.")
