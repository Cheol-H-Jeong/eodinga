...
class SettingsTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setAccessibleDescription("Configure launcher behavior, hotkeys, and theme settings.")
        self._hotkey_combo = "ctrl+shift+space"
        layout = QVBoxLayout(self)
        self.title_label = QLabel("Settings", self)
        self.title_label.setProperty("role", "title")
        self.title_label.setAccessibleName("Settings tab title")
        body = QLabel("Configure the hotkey, theme, and launcher window behavior.", self)
        body.setProperty("role", "secondary")
        body.setAccessibleName("Settings tab summary")
        body.setAccessibleDescription("Summarizes the launcher hotkey and window preferences available here.")
        self.system_theme_checkbox = QCheckBox("Use system theme", self)
        self.system_theme_checkbox.setAccessibleName("Use system theme")
        self.system_theme_checkbox.setAccessibleDescription("Follow the operating system theme when supported.")
        ...
        self.frameless_checkbox.setAccessibleDescription("Remove the standard window frame from the launcher.")
        ...
        self.always_on_top_checkbox.setAccessibleDescription("Keep the launcher above other windows while visible.")
        ...
        self.hotkey_label.setAccessibleDescription("Shows the currently registered launcher hotkey.")
        self.remap_hotkey_button = SecondaryButton("Remap hotkey", self)
        self.remap_hotkey_button.setAccessibleName("Remap hotkey")
        self.remap_hotkey_button.setAccessibleDescription("Choose a new global shortcut for opening the launcher.")
