...
class SettingsTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.system_theme_checkbox.setAccessibleDescription("Follow the operating system theme for the main window.")
        ...
        self.frameless_checkbox.setAccessibleDescription("Toggle the launcher popup window frame on or off.")
        ...
        self.always_on_top_checkbox.setAccessibleDescription("Keep the launcher popup above other windows.")
        ...
        self.hotkey_label.setAccessibleDescription("Shows the current global launcher hotkey binding.")
        self.remap_hotkey_button = SecondaryButton("Remap hotkey", self)
        self.remap_hotkey_button.setAccessibleName("Remap hotkey")
        self.remap_hotkey_button.setAccessibleDescription("Choose a new global keyboard shortcut for opening the launcher.")
