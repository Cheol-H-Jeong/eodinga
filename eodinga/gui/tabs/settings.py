...
class SettingsTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.system_theme_checkbox.setAccessibleDescription("Follow the operating system theme selection.")
        ...
        self.frameless_checkbox.setAccessibleDescription("Toggle the launcher's frameless window style.")
        ...
        self.hotkey_label.setAccessibleDescription("Shows the currently configured launcher hotkey.")
        self.remap_hotkey_button = SecondaryButton("Remap hotkey", self)
        self.remap_hotkey_button.setAccessibleName("Remap hotkey")
        self.remap_hotkey_button.setAccessibleDescription("Choose a different global launcher hotkey.")
