...
class IndexTab(QWidget):
    def __init__(self, parent=None) -> None:
        ...
        self.setAccessibleDescription("Review index status and trigger maintenance actions.")
        ...
        self.status_chip.setAccessibleDescription("Current indexing state.")
        ...
        self.rebuild_button.setAccessibleDescription("Rebuild the full index from the configured roots.")
