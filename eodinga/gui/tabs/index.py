...
class IndexTab(QWidget):
    def __init__(self, parent=None) -> None:
        ...
        self.body_label = QLabel("Observe index health, rebuild, and vacuum.", self)
        self.body_label.setProperty("role", "secondary")
        self.body_label.setAccessibleName("Index tab guidance")
        ...
        self.progress_label.setAccessibleName("Indexing progress summary")
