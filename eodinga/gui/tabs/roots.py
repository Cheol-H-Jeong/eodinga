...
class RootsTab(QWidget):
    def __init__(self, parent=None) -> None:
        ...
        self.setAccessibleDescription("Manage which filesystem roots are indexed.")
        ...
        body.setAccessibleName("Roots tab summary")
        body.setAccessibleDescription("Explains how indexed paths and exclude rules are managed.")
        self.add_root_button = PrimaryButton("Add root", self)
        self.add_root_button.setAccessibleName("Add root")
        self.add_root_button.setAccessibleDescription("Add a filesystem root to the index.")
        ...
        self.remove_root_button.setAccessibleDescription("Remove the currently selected filesystem root.")
