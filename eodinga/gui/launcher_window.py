...
class LauncherWindow(LauncherPanel):
    ...
    def set_always_on_top(self, enabled: bool) -> None:
        ...
        self._save_launcher_config(always_on_top=enabled)
    ...
    def set_frameless(self, enabled: bool) -> None:
        ...
        self._save_launcher_config(frameless=enabled)
    ...
    def _save_launcher_config(self, **updates: int | bool) -> None:
        if self._config is None or self._config_path is None:
            return
        next_launcher = self._config.launcher.model_copy(update=updates)
        if next_launcher == self._config.launcher:
            return
        self._config.launcher = next_launcher
