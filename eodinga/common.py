...
class StatsSnapshot(BaseModel):
    ...
    watcher_counters: dict[str, int] = Field(default_factory=dict)
    watcher_histograms: dict[str, dict[str, object]] = Field(default_factory=dict)
    indexing_counters: dict[str, int] = Field(default_factory=dict)
    indexing_histograms: dict[str, dict[str, object]] = Field(default_factory=dict)
    logging_counters: dict[str, int] = Field(default_factory=dict)
