...
control_lines = [
    f"Package: {template_entries['Package']}",
    "Version: ${VERSION}",
    f"Section: {template_entries['Section']}",
    f"Priority: {template_entries['Priority']}",
    "Architecture: ${ARCH}",
    f"Maintainer: {template_entries['Maintainer']}",
    "Depends: python3 (>= 3.11)",
    f"Description: {template_entries['Description']}",
]
