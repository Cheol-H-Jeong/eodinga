...
- Instrumented query result volume and crash-log writes, so runtime metrics now show how many hits were returned or estimated over time and whether the current process emitted crash artifacts.
