...
- Extended the staged-build removal regression to accept a live update in the surviving root after reopen, confirming restart recovery preserves ongoing watcher-driven search updates as well as stored query state.
