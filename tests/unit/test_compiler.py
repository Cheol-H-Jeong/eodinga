...
def test_compile_iso_year_literal_uses_full_year_range() -> None:
    compiled = compile_query(parse("date:2026"))
    branch = compiled.branches[0]
...
def test_compile_iso_month_literal_uses_full_month_range() -> None:
    compiled = compile_query(parse("date:2026-04"))
    branch = compiled.branches[0]
