...
def test_launcher_accessible_names_cover_keyboard_surface(qapp) -> None:
    ...
    assert launcher.action_bar.open_button.toolTip() == "Open selected result (Enter)"
    ...
    assert launcher.action_bar.reveal_button.toolTip() == "Reveal selected result (Ctrl+Enter)"
    ...
    assert launcher.action_bar.copy_path_button.toolTip() == "Copy selected result path (Alt+C)"
    ...
    assert launcher.action_bar.copy_name_button.toolTip() == "Copy selected result name (Alt+N)"
