...
def test_launcher_accessible_names_cover_keyboard_surface(qapp) -> None:
    ...
    assert launcher.query_summary_row.accessibleName() == "Active launcher query summary"
    ...
    assert launcher.empty_state.body_label.accessibleName() == "Launcher empty state details"
    assert launcher.empty_state.details_label.accessibleName() == "Launcher indexing details"
    assert launcher.status_chip.accessibleName() == "Launcher status state"
    assert launcher.shortcut_label.accessibleName() == "Launcher shortcut hints"
    assert launcher.status_label.accessibleName() == "Launcher search status"
