...
def test_search_root_scope_matches_windows_extended_length_drive_paths(
    tmp_db: sqlite3.Connection,
) -> None:
    now = 1_713_528_000
    _insert_file(tmp_db, 1, r"C:\workspace\reports\alpha.txt", 1024, now, "txt", body_text="alpha")
...
def test_search_root_scope_matches_windows_extended_length_unc_paths(
    tmp_db: sqlite3.Connection,
) -> None:
    now = 1_713_528_000
    _insert_file(
    ...
    assert hits == [Path(r"\\server\share\reports\alpha.txt")]
