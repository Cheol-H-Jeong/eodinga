...
def test_search_root_scope_matches_windows_extended_length_descendants(
    tmp_db: sqlite3.Connection,
) -> None:
    now = 1_713_528_000
    _insert_file(tmp_db, 1, r"\\?\C:\workspace\reports\alpha.txt", 1024, now, "txt", body_text="alpha")
...
def test_search_root_scope_matches_standard_windows_paths_from_extended_length_root(
    tmp_db: sqlite3.Connection,
) -> None:
    now = 1_713_528_000
    _insert_file(tmp_db, 1, r"C:\workspace\reports", 0, now, "", is_dir=1)
