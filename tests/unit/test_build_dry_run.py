...
def test_windows_audit_validator_rejects_missing_versioned_installer_artifact() -> None:
    module = _load_build_module()
    payload = module._audit_windows_inputs(__version__, __version__)
    payload["target"] = "windows"
    ...
    assert "Windows build is missing the versioned installer artifact" in errors
