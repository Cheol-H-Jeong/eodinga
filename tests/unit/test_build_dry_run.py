...
def test_linux_appimage_audit_validator_rejects_checksum_drift() -> None:
    module = _load_build_module()
    payload = {
        "version": __version__,
        "arch": "x86_64",
    ...
    assert "AppImage archive SHA-256 companion file no longer matches the staged archive" in errors
