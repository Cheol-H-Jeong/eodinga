...
def test_linux_deb_audit_validator_rejects_control_metadata_drift() -> None:
    module = _load_build_module()
    payload = {
        "version": __version__,
        "arch": "amd64",
    ...
    assert "Debian control template section drifted from the staged package" in errors
